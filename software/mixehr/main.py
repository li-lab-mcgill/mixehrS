import argparse
import logging
from mixehr.smixehr_cvb0 import Corpus, MixEHR
import numpy as np
import os
import sys
...
parser.add_argument('output', help='Directory to store model')
...
parser_split.add_argument("-m", "--model", help="Path to model")
